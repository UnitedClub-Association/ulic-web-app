...
type ProfileProps = { userProfile: any; };

export default function Layout2({ userProfile }: ProfileProps) {
    return (
            ...
            <div className={styles.profileBody}>
                ...
                <div className={styles.rightColumn}>
                    ...
                    <div className={styles.badges}>
                        {userProfile.badges.map((badge: string) => <span key={badge} className={styles.badge}>{badge}</span>)}
                    </div>
                </div>
            </div>
